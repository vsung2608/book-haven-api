//package com.bookhaven.order_service.configuration;
//
...
//            if (isNull(client)) {
//                throw new IllegalStateException("client credentials flow on %s failed, client is null".formatted(clientRegistration.getRegistrationId()));
//            }
//            return client.getAccessToken().getTokenValue();
//        } catch (Exception exp) {
//            logger.error("client credentials error %s".formatted(exp.getMessage()));
//        }
//        return null;
//    }
//}
